...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.40/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| SPINES | Vlan4094 | 192.168.52.1 | Port-Channel11 |
...
| Ethernet11 | MLAG_PEER_SPINE2_Ethernet11 | *trunk | *2-4094 | *- | *['MLAG'] | 11 |
| Ethernet12 | MLAG_PEER_SPINE2_Ethernet12 | *trunk | *2-4094 | *- | *['MLAG'] | 11 |
...
interface Ethernet11
   description MLAG_PEER_SPINE2_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description MLAG_PEER_SPINE2_Ethernet12
   no shutdown
   channel-group 11 mode active
```
...
| Port-Channel11 | MLAG_PEER_SPINE2_Po11 | switched | trunk | 2-4094 | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel11
   description MLAG_PEER_SPINE2_Po11
   no shutdown
   switchport
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan4094 |  default  |  192.168.52.0/31  |  -  |  -  |  -  |  -  |  -  |
